...
const ReportComponent = ({ onReportConfirmation }: Props) => {
    ...
    function handleReportSelection(event: ChangeEvent<HTMLInputElement>): void {
        ...
        if (file) {
            ...
            if (isValidDoc) {
                const reader = new FileReader();
                // Docs are not compressed. Might add note that up to 1MB supported. Or use server-side compression libraries.
                reader.onloadend = () => {
                    const base64String = reader.result as string;
                    setBase64Data(base64String);
                    console.log(base64String);
        ...
        <div className="grid w-full items-start gap-6 overflow-auto p-4 pt-0">
            <fieldset className='relative grid gap-6 rounded-lg border p-4'>
                ...
                <Textarea
                    ...
                    placeholder="Extracted data from the document will appear here. Get more accurate recommendations by providing additional case details or background information..."
